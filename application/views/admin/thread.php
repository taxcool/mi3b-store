...
<div class="pagination"><?=$links;?><?=form_open('admin/forum/search/1');?><input type="text" value="Search" name="search" title="keyword" onfocus="clearText(this)" onblur="clearText(this)" /><input type="submit"></form></div>
<div class="table"><table border="0" align="center" cellpadding="5" cellspacing="0">
  <tr bgcolor="azure">
    <th align="center">Id</th>
    <th align="center">Id Category</th>
    <th width="40%" align="center">Title</th>
    <th align="center">Body</th>
    <th align="center">Viewed </th>
    <th align="center">Inserted By </th>
    ...
    <th width="15%" align="center">Action</th>
					...
					$field = 0;
					foreach($thread->result_array() as $thr):?>
	<tr align="center" 
    ...
    <td ><?php echo "$thr[id]"; ?></td>
	<td ><?php echo "$thr[id_category]"; ?></td>
	<td ><?php echo "$thr[title]"; ?></td>
	<td ><?php echo "$thr[body]"; ?></td>
    <td ><?php echo "$thr[viewed]"; ?></td>
    <td ><?php echo "$thr[inserted_by]"; ?></td>
    <td ><?php if($thr['is_deleted'] == 0) echo "Actived";else echo "Not Actived"; ?></td>
    <td ><a href="<?=base_url();?>index.php/admin/forum/1/edit/<?=$thr['id'];?>"><img src="<?=base_url();?>/style/images/edit.gif" height="20"></a> <a href="<?=base_url();?>index.php/admin/forum/1/view/<?=$thr['id'];?>"><img src="<?=base_url();?>/style/images/view.png" height="25"></a> <a href="<?=base_url();?>index.php/admin/forum/1/delete/<?=$thr['id'];?>"><img src="<?=base_url();?>/style/images/delete.png" height="20"></a></td>
    </tr>
