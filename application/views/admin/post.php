...
<div class="pagination"><?=$links;?><?=form_open('admin/forum/search/2');?> <input type="text" value="Search" name="search" title="keyword" onfocus="clearText(this)" onblur="clearText(this)" /><input type="submit"></form></div>
<div class="table"><table border="0" align="center" cellpadding="5" cellspacing="0">
  <tr bgcolor="azure">
    <th align="center">Id Thread</th>
    <th width="40%" align="center">Post</th>
    ...
    <th width="20%" align="center">Action</th>
					...
					$field = 0;
					foreach($post->result_array() as $thr):?>
	<tr align="center" 
    ...
    <td ><?php echo "$thr[id_thread]"; ?></td>
	<td ><?php echo "$thr[post]"; ?></td>
	<td ><?php echo "$thr[inserted_by]"; ?></td>
    <td ><?php if($thr['is_deleted'] == 0) echo "Actived";else echo "Not Actived"; ?></td>
    <td ><a href="<?=base_url();?>index.php/admin/forum/2/edit/<?=$thr['id'];?>"><img src="<?=base_url();?>/style/images/edit.gif" height="20"></a> <a href="<?=base_url();?>index.php/admin/forum/2/view/<?=$thr['id'];?>"><img src="<?=base_url();?>/style/images/view.png" height="25"></a> <a href="<?=base_url();?>index.php/admin/forum/2/delete/<?=$thr['id'];?>"><img src="<?=base_url();?>/style/images/delete.png" height="20"></a></td>
    </tr>
